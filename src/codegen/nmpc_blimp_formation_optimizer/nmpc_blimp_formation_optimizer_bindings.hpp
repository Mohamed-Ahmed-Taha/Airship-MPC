...
static const uintptr_t NMPC_BLIMP_FORMATION_OPTIMIZER_NUM_DECISION_VARIABLES = 123;

/// Number of parameters
static const uintptr_t NMPC_BLIMP_FORMATION_OPTIMIZER_NUM_PARAMETERS = 33;

/// Number of parameters associated with augmented Lagrangian
static const uintptr_t NMPC_BLIMP_FORMATION_OPTIMIZER_N1 = 0;

/// Number of penalty constraints
static const uintptr_t NMPC_BLIMP_FORMATION_OPTIMIZER_N2 = 1;

/// nmpc_blimp_formation_optimizer version of ExitStatus
/// Structure: `nmpc_blimp_formation_optimizerExitStatus`
enum class nmpc_blimp_formation_optimizerExitStatus {
...
///
struct nmpc_blimp_formation_optimizerCache;

/// nmpc_blimp_formation_optimizer version of AlmOptimizerStatus
/// Structure: `nmpc_blimp_formation_optimizerSolverStatus`
///
struct nmpc_blimp_formation_optimizerSolverStatus {
  /// Exit status
  nmpc_blimp_formation_optimizerExitStatus exit_status;
...
nmpc_blimp_formation_optimizerCache *nmpc_blimp_formation_optimizer_new();
...
nmpc_blimp_formation_optimizerSolverStatus nmpc_blimp_formation_optimizer_solve(nmpc_blimp_formation_optimizerCache *instance,
                                                                                double *u,
                                                                                const double *params,
                                                                                const double *y0,
                                                                                const double *c0);
...
/// # Safety
/// All arguments must have been properly initialised
void nmpc_blimp_formation_optimizer_free(nmpc_blimp_formation_optimizerCache *instance);
